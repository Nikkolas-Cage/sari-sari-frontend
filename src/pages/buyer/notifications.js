...
function NotificationsList({ role }) {
  ...
  return (
    <>
      <Flex justify="space-between" align="center" mb={4}>
        <Text color="gray.600">
          {role === "buyer"
            ? "Order updates, ready for pickup, and new messages"
            : "Messages, inquiries, cart activity, and pickup orders"}
        </Text>
            ...
            return (
              ...
              >
                <HStack align="start" spacing={3}>
                  <Avatar size="md" name={n.actorName || "Store"} src={n.actorAvatarUrl || undefined} />
                  <Box flex="1" minW={0}>
